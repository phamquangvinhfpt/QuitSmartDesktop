namespace QuitSmartApp.Configuration
{
    ...
    {
        // Database settings
        public const string DefaultConnectionString = "Server=(localdb)\\MSSQLLocalDB;Database=QuitSmartDesktop;Trusted_Connection=true;MultipleActiveResultSets=true";
